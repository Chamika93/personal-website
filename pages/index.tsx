      ...
      <div className='mt-16'>
        ...
        <div>
          <div className='mt-12'>
            ...
            <p className='mt-4'>I have a set of baseline CSS styles that come with me from project to project. In the past, I'd use a typical CSS reset, but times have changed, and I believe I have a better set of global styles!</p>
          </div>
          <div className='mt-12'>
            <h4 className='text-lg font-bold'>My Custom CSS Reset</h4>
            <p className='mt-4'>I have a set of baseline CSS styles that come with me from project to project. In the past, I'd use a typical CSS reset, but times have changed, and I believe I have a better set of global styles!</p>
